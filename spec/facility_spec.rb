...
RSpec.describe Facility do
  ...
  describe '#Getting a Drivers License' do
    ...
    describe '#Administer a written test' do
      ...
      it 'add_service for registrant_1' do
      ...
      it 'add_service for registrant_2' do
      ...
      it 'does not add_service for registrant_3' do
    ...
    describe '#Administer a road test' do
      ...
      it 'add_service road test for registrant_1' do
        @facility_1.add_service('Road Test')
        expect(@facility_1.administer_road_test(@registrant_1)).to be true
        expect(@registrant_1.license_data).to eq({:written=>true, :license=>true, :renewed=>false})
      end

      it 'add_service road test for registrant_2' do
        @facility_1.add_service('Road Test')
        @registrant_2.earn_permit
    ...
    describe 'Renew a drivers license' do
      ...
      it 'add_service Renew License for registrant_1' do 
        @facility_1.add_service('Renew License')
        expect(@facility_1.renew_drivers_license(@registrant_1)).to be true
        expect(@registrant_1.license_data).to eq({:written=>true, :license=>true, :renewed=>true})
      end

      it 'can not add_service Renew License for registrant_3' do
        expect(@facility_1.renew_drivers_license(@registrant_3)).to be false
        expect(@registrant_3.license_data).to eq({:written=>false, :license=>false, :renewed=>false})
      end

      it 'add_service Renew License for registrant_2' do 
        @facility_1.add_service('Renew License')
